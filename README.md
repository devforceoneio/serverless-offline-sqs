# @devforceoneio/serverless-offline-sqs
...
**Fork of [serverless-offline-sqs](https://github.com/CoorpAcademy/serverless-plugins) with AWS SDK v3 support.**

_Features_:

- ✅ **AWS SDK v3 compatible** - Uses `@aws-sdk/client-sqs` instead of deprecated `aws-sdk`
- ✅ [Serverless Webpack](https://github.com/serverless-heaven/serverless-webpack/) support
- ✅ SQS configurations: batchsize
- ✅ ElasticMQ XML response handling
...
```sh
npm install git+ssh://git@github.com:devforceoneio/serverless-offline-sqs.git#v8.1.0
```

Or with pnpm:

```sh
pnpm add -D git+ssh://git@github.com:devforceoneio/serverless-offline-sqs.git#v8.1.0
```

### Option 2: Install from npm (If Published)

```sh
npm install @devforceoneio/serverless-offline-sqs
```
